...
const s = {
  ...
  logo: { width: 64, height: 64, borderRadius: 16, objectFit: 'cover', marginBottom: 12 },
  title: { fontSize: 26, fontWeight: 800, color: '#1B5E20', margin: '0 0 4px', letterSpacing: '-0.5px' },
  ...
  dividerText: { color: '#CCC', fontSize: 13, whiteSpace: 'nowrap' },
  ...
  error: { color: '#C62828', fontSize: 13, margin: '0', textAlign: 'center' },
  success: { color: '#1B5E20', fontSize: 13, margin: '0', textAlign: 'center' },
  submitBtn: {
    width: '100%',
    padding: '14px',
    background: '#1B5E20',
